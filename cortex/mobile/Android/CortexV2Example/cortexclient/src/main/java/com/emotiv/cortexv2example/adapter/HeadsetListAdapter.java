...
public class HeadsetListAdapter extends ArrayAdapter<HeadsetObject> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView tvIsVirtualHeadset = (TextView) convertView.findViewById(R.id.tvIsVirtualHeadset);
        tvIsVirtualHeadset.setText(headsets.get(position).isVirtualHeadset() ? "yes" : "no");
