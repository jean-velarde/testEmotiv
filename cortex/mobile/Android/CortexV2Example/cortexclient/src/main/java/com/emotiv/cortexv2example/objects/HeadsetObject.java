...
public class HeadsetObject {
    ...
    boolean isVirtualHeadset = false;
    String virtualHeadsetId = "";
    ...
    public boolean isVirtualHeadset() { return isVirtualHeadset; }

    public String getVirtualHeadsetId() { return virtualHeadsetId; }
    ...
    public void setVirtualHeadset(boolean virtual) {
        isVirtualHeadset = virtual;
    }

    public void setVirtualHeadsetId(String vhsId) { virtualHeadsetId = vhsId;}
}
